...
var cnItems = {
    ...
    "An empty set of maintenance mountings, designed for use with a range of Exosuit models.": "一套空的维护支架，设计用于一系列 防护服 型号。",
    ...
    "Exosuit required for safe traversal.": "安全穿越所需的防护服。",
    ...
    "The sole remaining exhibit is a rather large Exosuit in the centre of the room.": "唯一剩下的展品是房间中央的一个相当大的 护甲。",
    "There's a Model #### Exosuit in the centre of the area. Four metal claws are holding it in place.": "该区域的中心有一个模型#### 护甲。 四个金属爪将其固定到位。",
