...
var cnItems = {
    ...
    " A self-locking electronic supply closet lies on the floor. Presumably someone was working here recently, before the incident.": "自锁电子供应柜位于地板上。 据推测，在事件发生之前，最近有人在这里工作。",
    "The garbage disposal chute is jammed shut. It cannot be opened by hand.": "垃圾处理槽被卡住了。 它不能用手打开。",
    "Activate Life Support": "激活生命支持",
    "The circuit has been fully repaired. Throw the switch and reactivate life support!": "电路已完全修复。 扔掉开关，重新启动生命维持系统！",
    "You can now explore the corridors without relying on oxygen reserves.": "您现在可以在不依赖氧气储备的情况下探索走廊。",
    "Stability": "续航",
    ...
    "A network interface of sorts, with three prongs in the shape of a triangle. Something should fit here...": "各种网络接口，具有三角形形状的三个插脚。 东西应该适合这里......",
    ...
    "The main central elevator for the installation. With the current level of power, the elevator cannot move from the basement floor.": "安装的主要中央电梯。 以目前的功率水平，电梯无法从地下室移动。",
    "There's an emergency hatch on the roof of the elevator, with a small ladder you can extend upwards from it. It should be high enough to scale one extra floor if need be.": "电梯顶上有一个应急舱口，上面有一个小梯子可以向上延伸。 如果需要，它应该足够高以增加一层。",
    "This generator is missing a voltage regulator, now part of the life support system.": "这台发电机缺少电压调节器，现在是生命支持系统的一部分。",
    "This generator looks incomplete - the alternator is missing.": "这个发电机看起来不完整——交流发电机不见了。",
    ...
    "WEST DOORWAY": "西门",
    "(unpowered": "（无动力",
    "A heavy steel door. Without power it would need to be held open.": "一扇沉重的钢门。 没有电源，它需要保持打开状态。",
    ...
    "The corridor is about as empty as before. One of the potted plants has been knocked over, in the rush to escape. One of the bathrooms is leaking water out into the hallway.": "走廊和以前一样空荡荡。 一盆盆栽被撞倒，急于逃跑。 其中一间浴室漏水到走廊。",
    ...
    "The door is damaged, you can see through it but you'll need force to pull it open.": "门坏了，你可以看穿它，但你需要用力才能把它拉开。",
    "The door is only jacked up enough for you to slip through. The box is far too large to fit.": "门被顶起来，足以让你滑过。 盒子太大了，装不下。",
    ...
    "The main central elevator for the installation. With the current level of power, the elevator can go as high as 1F.": "安装的主要中央电梯。 以目前的功率等级，电梯可以上到1层。",
    ...
    "It's too dangerous to work on the generator whilst it's active.": "在发电机处于活动状态时在发电机上工作太危险了。",
    ". You'll need to exit the elevator and remove the box from it.": ". 您需要退出电梯并从中取出盒子。",
    "A warning on the panel reads": "面板上的警告写着",
    "Install the mystery box": "安装神秘盒子",
    "Move Box to Network Interface": "将 盒子 移至网络接口",
    "Retrieve Jack": "取回千斤顶",
    "The main central elevator for the installation. With the current level of power, the elevator can go as high as 2F.": "安装的主要中央电梯。 以目前的功率水平，电梯可以上到2层。",
    "The security door to 1> is locked. The box cannot be moved that way.": "通往 1> 的安全门已锁定。 盒子不能那样移动。",
    ...
    "Alternator": "交流发电机",
    "A heavy steel door. Without power you'll need the jack to hold it open.": "一扇沉重的钢门。 在没有电源的情况下，您需要使用千斤顶将其保持打开状态。",
    "Crowbar": "撬棍",
    "Pry open the door to Decontamination": "撬开净化室大门",
    "Pry open the door to Laboratory": "撬开实验室的门",
    "Remove the jack from the Decontamination door.": "从净化门上取下千斤顶。",
    ...
    "The floor in here looks to be extremely damaged, too. Another solid impact and it might give way entirely.": "这里的地板看起来也严重受损。 另一个坚实的影响，它可能完全让位。",
    ...
    "There's an emergency hatch on the roof of the elevator, but looking through it, you can see the elevator shaft above is blocked. You won't be able to scale further with the ladder.": "电梯顶上有一个应急舱口，但透过它，你可以看到上面的电梯井被堵住了。 您将无法使用梯子进一步扩展。",
