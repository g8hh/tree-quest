addLayer("m", {
        ...
        branches() {
            branchlist = ["c1","c2","c3","c4","c5","c6","c7","c8"]
            return branchlist
        },
...
buyables: {},
        ...
        update(diff) {
            ...
            //C1
            temp_power = layers["c1"].power_cycle[temp_power,layers[this.layer].powerBase(),diff]
            //C2
            temp_power = layers["c2"].power_cycle[temp_power,layers[this.layer].powerBase(),diff]
            //C3
            temp_power = layers["c3"].power_cycle[temp_power,layers[this.layer].powerBase(),diff]
            //C4
            temp_power = layers["c4"].power_cycle[temp_power,layers[this.layer].powerBase(),diff]
            //C5
            temp_power = layers["c5"].power_cycle[temp_power,layers[this.layer].powerBase(),diff]
            //C6
            temp_power = layers["c6"].power_cycle[temp_power,layers[this.layer].powerBase(),diff]
            //C7
            temp_power = layers["c7"].power_cycle[temp_power,layers[this.layer].powerBase(),diff]
            //C8
            temp_power = layers["c8"].power_cycle[temp_power,layers[this.layer].powerBase(),diff]
